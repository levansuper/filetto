  ...
  errors: function(api){
    return {
      ...
      serverErrorMessage: function(){
        return { code : 50000, message : 'The server experienced an internal error' };
      },
      ...
      missingParams: function(params){
        return { code : 50001, message : params[0] + ' is a required parameter for this action' };
      },

      // user requested an unknown action
      unknownAction: function(action){
        return { code : 50002, message : 'unknown action or invalid apiVersion' };
